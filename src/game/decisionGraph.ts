  ...
  choices: [
    {
      ...
      effects: [{ path: "augmentation", pathDelta: 1, standingDelta: -3 }],
  ...
  choices: [
    {
      ...
      primaryPath: "proworker",
      effects: [
        { path: "proworker", pathDelta: 1, standingDelta: -2 },
    ...
    },
    {
      ...
      followupBody:
        "Priya builds AI agents into your workflows, connected to Figma and Google for fast creative first drafts. Some projects are now nearly AI end-to-end. Your team jumps to #2.",
      next: "y2027news",
    },
    {
      id: "B2",
  ...
  choices: [
    {
      ...
      description:
        "AI output needs managing. Someone has to catch errors, maintain brand voice, and keep the quality from quietly dropping.",
      color: "teal",
      primaryPath: "augmentation",
  ...
  choices: [
    {
      ...
      summary: "Team monitoring AI",
      description:
        "You build a dashboard for Gillette. Every ad is tracked and ranked by performance in real time. Your team monitors the dashboard and replaces low-performing ads as soon as they start to slip.",
      color: "teal",
      primaryPath: "augmentation",
      effects: [{ path: "augmentation", pathDelta: 4, standingDelta: 3 }],
      followupHeading: "Follow-up · Automate Smarter",
      followupBody:
        "AI speed with human judgment. Gillette takes you up on the proposal. Jade steps into dashboard management, and your ads start cutting through again. But Jade has a lot on her plate now. You notice dark circles under her eyes…",
      next: "y2029ctx",
    },
    {
      id: "B",
      ...
      description:
        "You pitch Gillette on a fully agentic AI ad generator trained on their customer data. Every ad will have real-time personalization!",
      color: "orange",
      primaryPath: "erosion",
      effects: [
        {
    ...
    },
    {
      ...
      description:
        "You tell Gillette to stop chasing endless personalization. Instead, you launch IRL barbershop activations across the country. Risky, especially for a digital-first agency.",
      color: "forest",
      primaryPath: "proworker",
      effects: [{ path: "proworker", pathDelta: 4, standingDelta: -3 }],
  ...
  choices: [
    {
      ...
      description:
        "Jade stepped into the AI dashboard role in 2028, and has been burning out quietly. You propose hiring some to help!",
      color: "teal",
      primaryPath: "augmentation",
      effects: [{ path: "augmentation", pathDelta: 3, standingDelta: -2 }],
    ...
    },
    {
      ...
      description:
        "Your team is doing great, but it is clear the work no longer needs this many hands. You can use the savings to help one or two junior staff retrain for new roles.",
      color: "forest",
      primaryPath: "proworker",
      effects: [
        {
...
export const MAIN_DECISIONS: YearDecision[] = [
  Y2025,
  Y2026,
  Y2027,
  Y2028,
    ...
    choices: [
      {
        ...
        description:
          "Lean into craft and hand illustration. Make the human origin visible.",
        color: "forest",
        primaryPath: "proworker",
        effects: [],
      ...
      },
      {
        ...
        description:
          "Keep the AI engine, but put a human creative lead on every campaign to shape the concept and make final calls.",
        color: "teal",
        primaryPath: "augmentation",
        effects: [],
        next: "end_augmentation_7",
    ...
    choices: [
      {
        ...
        description:
          "Bring in a contractor to scan campaigns for obvious issues.",
        color: "orange",
        primaryPath: "erosion",
        effects: [],
        next: "end_erosion_3",
...
const SHRINKAGE_BRANCH: YearDecision[] = [
  {
    ...
    promptShort:
      'You get a "promotion" — the team is reduced to you and the agents.',
    choices: [
      {
        id: "→",
        title: "CONTINUE",
        description:
          "On paper, a promotion. In practice, you’re the last human.",
        color: "mustard",
        primaryPath: "shrinkage",
        effects: [],
...
const PROWORKER_BRANCH: YearDecision[] = [
  {
    ...
    promptShort:
      "AI gains must be shared. You redesign roles around human capabilities.",
    choices: [
      {
        id: "→",
        title: "CONTINUE",
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        title: "ABSTAIN",
        description:
          "Step back. The policy feels too messy to choose either way.",
        color: "mustard",
        primaryPath: "proworker",
        effects: [],
        next: "end_proworker_5",
...
function pickBestChoice(
  ...
  return matches.reduce((best, c) => {
    ...
    const bestDelta =
      best.effects.find((e) => e.path === target)?.pathDelta ?? 0;
