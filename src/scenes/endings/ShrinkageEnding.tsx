...
export function EndShrinkage1Scene() {
  ...
  return (
    <>
      ...
      <Memo
        headerColor="mustard"
        headerLeft="ALEX'S OFFICE · 2031"
        headerRight=""
      >
        <p>
          The AI Job Preservation &amp; Work Sharing Act did not pass. Alex is
          happy. Honestly, part of you might be too.
        </p>
        <p>
          Without new rules, 2760 Inc. doesn&apos;t have to prove that AI
          productivity gains are being shared with workers. The company can move
          fast, stay lean, and keep margins high.
        </p>
        <p>
          Alex calls you into her office. You brace yourself. But she smiles.
        </p>
      </Memo>
      ...
      <AlexDialogue text={text} onDone={() => setUnlocked(true)}>
        <Memo style={{ margin: 0 }}>
          <p>
            On paper, it&apos;s a promotion. Your title is bigger. Your salary
            is better. Your &quot;team&apos;s&quot; output has barely dropped.
          </p>
        </Memo>
      </AlexDialogue>
...
export function EndShrinkage2Scene() {
  ...
  return (
    <>
      ...
      <Memo
        headerColor="mustard"
        headerLeft="INBOX · 5:00 PM"
        headerRight="AUTOMATED"
      >
        <p>
          You get an email at 5pm. It&apos;s clearly automated — Gillette sent
          it to every agency they work with.
        </p>
      </Memo>
      ...
      >
        ...
        >
          ...
          <span style={{ color: "var(--paper)", fontSize: 10, opacity: 0.5 }}>
            5:00 PM
          </span>
        </div>
        <div
        ...
        <div style={{ padding: "20px 24px", fontSize: 13, lineHeight: 1.7 }}>
          ...
          <p style={{ marginBottom: 12 }}>
            Thank you for your partnership over the past several years. As part
            of our ongoing investment in internal AI marketing capabilities,
            Gillette will be transitioning targeted campaign development and
  ...
  return (
    <>
      ...
      <Memo
        ...
        headerLeft="NOT ENOUGH WORK TO GO AROUND"
        headerRight=""
      >
      ...
      <AlexDialogue text={text} onDone={() => setUnlocked(true)}>
        <Memo style={{ margin: 0 }}>
          ...
          >
            It isn&apos;t personal. That&apos;s what makes it hard to argue
            with.
          </p>
        </Memo>
      </AlexDialogue>
...
function ShrinkageTerminationScreen({
  followupText,
}: {
  followupText: string;
}) {
  ...
  const emailLocal = (state.name || "employee")
    .toLowerCase()
    .replace(/\s+/g, ".");
  return (
      ...
      >
        ...
        <div style={{ padding: "20px 24px", position: "relative" }}>
          ...
          <p style={{ fontSize: 13, lineHeight: 1.65, marginBottom: 8 }}>
            We regret to inform you that your role is no longer required in our
            marketing operations. This decision was not performance-based.
          </p>
...
export function EndShrinkageNoticeScene() {
  return (
    <ShrinkageTerminationScreen followupText="Unfortunately, you receive this email." />
  );
}
  ...
  return (
    <>
      ...
      >
        <div style={{ flex: 1 }}>
          <Memo headerLeft="POST-AGENCY LIFE" headerRight="">
            ...
            <p>
              The marketing industry didn&apos;t collapse, it just got smaller.
              There are no openings left for someone like you.
            </p>
            <p>
              You&apos;ve started looking at physical work. Data center
              maintenance. Infrastructure. Things that still need human hands,
              for now. You&apos;ll begin a retraining program next month.
            </p>
            <p>
              There are too few jobs now around the writing and storytelling
              that brought you to marketing in the first place.
            </p>
          </Memo>
        </div>
      ...
      <Btn
        ...
        className="continue-btn"
        onClick={() => {
          posthog.capture("ending_reached", { ending_path: "shrinkage" });
          go("end_shrinkage_final");
        }}
      >
        2035
      </Btn>
